    ...
    public class InfiniteScroll : UIBehaviour
    {
        ...
        protected override void Start()
        {
            ...
            for (int i = 0; i < instantateItemCount; i++)
            {
                ...
                item.anchoredPosition = m_Direction == Direction.Vertical ? new Vector2(0, (-itemScale * i) - (Spacing * i)) : new Vector2((itemScale * i) - (Spacing * i), 0);
        ...
        void Update()
        {
            ...
            while (anchoredPosition - diffPreFramePosition < -itemScale * 2)
            {
                ...
                // 위치지정
                var pos = (itemScale * instantateItemCount + itemScale * currentItemNo) + (Spacing * (currentItemNo + instantateItemCount));
            ...
            while (anchoredPosition - diffPreFramePosition > 0)
            {
                ...
                // 위치지정
                var pos = (itemScale * currentItemNo) + (Spacing * currentItemNo);
                item.anchoredPosition = (m_Direction == Direction.Vertical) ? new Vector2(0, -pos) : new Vector2(pos, 0);
